...
const About = () => {
  ...
  return (
    <div className="bg-white dark:bg-slate-950 min-h-screen pt-20">
      <SEO
        title="About Us"
        description="Learn about Arrotech's mission to pioneer the future of AI solutions for businesses worldwide."
        canonical="/about"
      />
      {/* Hero Section */}
        ...
        <div className="container relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-100 dark:bg-white/5 backdrop-blur-sm border border-slate-200 dark:border-white/10 mb-8">
              ...
              <span className="text-slate-700 dark:text-slate-300 text-sm font-medium">Our Story</span>
            </div>
            ...
            >
              {stats.map((stat, index) => (
                <motion.div
                  ...
                  className="bg-slate-50/80 dark:bg-slate-900/50 backdrop-blur-sm border border-slate-200 dark:border-slate-800 rounded-2xl p-6 text-center hover:border-slate-300 dark:border-slate-700 transition-all"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => (
              <motion.div
                ...
                className="group bg-slate-50/80 dark:bg-slate-900/50 backdrop-blur-sm border border-slate-200 dark:border-slate-800 rounded-2xl p-6 hover:border-slate-300 dark:border-slate-700 transition-all duration-500"
              >
